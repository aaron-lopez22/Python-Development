...
def main():
    ...
    user_input_molecule = input("Enter the molecular formula of the sample: ")
    # Get the mass of a chemical sample in grams from the user.
    user_input_mass = float(input("Enter the mass in grams of the sample: "))
    ...
    symbol_quantity_list = parse_formula(user_input_molecule, periodic_table)
...
def make_periodic_table():
    ...
    return periodic_table_list_dict
...
def compute_molar_mass(symbol_quantity_list, periodic_table_dict):
    ...
    for key, inner_list in symbol_quantity_list.items() :
        ...
        if symbol in periodic_table_dict:
            ...
            atomic_mass_index = value[ATOMIC_MASS_INDEX]

        # Multiply the atomic mass by the quantity.
            new = atomic_mass_index * quantity
